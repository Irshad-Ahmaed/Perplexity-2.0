  ...
  return (
    <form onSubmit={onSubmit} className="p-2 md:p-4 bg-white relative">
      <div className="flex items-center bg-[#F9F9F5] rounded-full p-2 md:p-3 shadow-md border border-gray-200">
        ...
        <button
          type="submit"
          className="bg-gradient-to-r from-teal-500 to-teal-400 hover:from-teal-600 hover:to-teal-500 rounded-full p-2 md:p-3 mr-2 md:mr-0 md:ml-2 shadow-md transition-all duration-200 group"
        >
          <svg
