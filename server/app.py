...
from langchain_core.messages import HumanMessage, ToolMessage, AIMessageChunk, SystemMessage
        ...
        for tool in tools:
            if tool.name == call["name"]:
                try:
                    ...
                    results.append(ToolMessage(content=f"Error: {str(e)}", tool_call_id=call["id"]))
...
builder.add_conditional_edges("model", tools_router, {"tool_node": "tool_node", "end": END})
